...
External financial information shocks are defined as discrete public events relevant to portfolio holdings that may trigger rapid market reactions and elevate decision urgency (add references here - this is not your definition). This thesis assumes (you cannot assume an accademic research paper - if the paradigm you embrace is that shocks affect decision behavior etc. refer to the literature that proposes these relationships) that shocks can affect decision behavior and, through decision behavior, influence portfolio outcomes, particularly when decisions are made over short horizons. The magnitude and persistence of market responses may vary by event type and context (also here refer to the literaure that proposes such relationship), and these relationships are treated as empirical questions to be evaluated through the study design. The Shock Score (here indicate that Shock Score is you own measure you´ve defined in chapater xx - if you got inspiration on how to build Shock Score, then add the relevant literature references) is introduced as a decision-support mechanism intended to structure interpretation of shock information and support disciplined responses.

The Shock Score is introduced as a decision-support mechanism intended to structure interpretation of shock information and support disciplined responses (this sentence is a repetition of the last sentence in the last paragraph above). As reviewed in Chapter 3, existing decision-support tools in finance are predominantly designed for quantitative analytics and algorithmic execution, while providing limited structural support for identifying or mitigating behavioral biases before decisions are made (add literaure reference here, also further expand on why you relate this concepts to the Shock Score).

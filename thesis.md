...
NRS responses reflect stated decision intentions rather than actual portfolio adjustments. The correspondence between stated intentions and revealed trading behavior has been documented to be imperfect in experimental finance research ([Huber et al., 2022](https://doi.org/10.1016/j.jebo.2021.12.007)). This limitation is common to survey-based studies of portfolio manager behavior and does not invalidate the within-subject comparison, but it restricts the external validity of the magnitude estimates.

...
The objectives of the study are as follows. They reflect a **hypothesized** causal logic, grounded in the behavioral finance literature ([Barberis & Thaler, 2003](https://doi.org/10.1016/S1574-0102(03)01027-6)), in which information shocks **may** affect managerial decisions, and decisions may in turn affect portfolio outcomes. This causal pathway is the subject of empirical investigation in this thesis, not an assumed conclusion.
